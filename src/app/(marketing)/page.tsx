  ...
  return (
    <main className="flex min-h-[calc(100vh-5rem)] flex-col items-center justify-between py-12">
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex p-2">
        ...
        <div className="flex w-full items-end justify-center lg:static lg:size-auto lg:bg-none">
          <p
            className="pointer-events-none flex place-items-center gap-2 p-8 lg:pointer-events-auto lg:p-0"
          >
            By <a href={siteConfig.links.x} target="_blank" rel="noreferrer" className="underline text-blue-400">@rds_agi</a>
          </p>
        </div>
      </div>
